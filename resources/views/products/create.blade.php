<x-app-layout>
    <div class="max-w-2xl">
        <div class="mb-6">
            <h1 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">Create Product</h1>
            <p class="text-gray-500 text-sm mt-1">Add a new item to your inventory</p>
        </div>

        <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data" class="bg-gray-100 dark:bg-neutral-900 rounded-xl p-6 space-y-5"
              x-data="{
                imageSource: 'file',
                previewUrl: null,
                cameraStream: null,
