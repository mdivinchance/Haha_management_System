<x-app-layout>
    <div class="p-6 max-w-2xl">
        ...
        <form method="POST" action="{{ route('categories.update', $category) }}" class="bg-neutral-900 rounded-xl p-6 space-y-5">
            @csrf @method('PATCH')
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="3"
                    class="block w-full rounded-lg border border-neutral-700 bg-neutral-800 px-4 py-2.5 text-white placeholder-gray-500 focus:border-teal-500 focus:ring-2 focus:ring-teal-500/30 focus:outline-none transition-colors text-sm">{{ old('description', $category->description) }}</textarea>
