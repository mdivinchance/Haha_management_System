                            ...
                            <tr class="text-gray-700 dark:text-neutral-300 hover:bg-gray-100 dark:hover:bg-neutral-800/50">
                                <td class="py-3 pr-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        @else
                                            <div class="h-8 w-8 rounded bg-gray-200 dark:bg-neutral-800 flex items-center justify-center text-xs text-gray-500 dark:text-neutral-500">N/A</div>
                                        @endif
                                        <span class="font-medium text-gray-900 dark:text-white">{{ $product->name }}</span>
                                    </div>
                                </td>
                                <td class="py-3 pr-4 text-gray-500 dark:text-neutral-400">{{ $product->category->name }}</td>
                                <td class="py-3 pr-4 font-mono text-xs text-gray-500 dark:text-neutral-500">{{ $product->sku }}</td>
